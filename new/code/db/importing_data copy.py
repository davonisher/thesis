...
def importing_data():
    try:
        ...
        feature_data = read_data('/Users/macbook/thesis/new/code/data/processed_data/stm.csv')
        ...
        category_data_column_mapping = {
            # mappings as per category_data CSV structure
